...
// ClanBomber.cpp:211/220 already appends "clanbomber" (and "clanbomber/maps")
// to whatever these helpers return, so we hand back the /switch parent — that
// gives the desired sdmc:/switch/clanbomber/{clanbomber.cfg,maps,...} layout
// without an extra nested folder.
std::filesystem::path GetHome() {
	return std::filesystem::path("sdmc:/switch");
}
